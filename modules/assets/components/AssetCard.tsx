...
import { Truck, Monitor, Wrench, Box, MapPin, User, ShieldAlert, Sparkles, MoreVertical, TrendingDown } from 'lucide-react';
...
const AssetCard: React.FC<AssetCardProps> = ({ asset, onClick, onAnalyze }) => {
  ...
  // Simulate health score based on last maintenance (demo logic)
